...
@export_range(0, 500) var air_acceleration := 10.0
## Air friction while in the air (how quickly the player slows down)
@export_range(0, 50) var air_resistance := 4.0
...
@export var jump_time_to_peak := .5
## Amount of time it takes the playe0 to fall from the peak of their jump to the ground
